...
def loadFundTransfer(source_acc_no,uname,customer_id):
	...
	customerFundTransferWindow.title("Welcome to Financial Crimes | Customer Fund Transfer")
	customerFundTransferWindow.state("zoomed")
	customerFundTransferWindow.columnconfigure(1, weight=6)

	#Logo
	logo = tk.Label(customerFundTransferWindow,text="Financial Crimes", font="Calibri 43")
