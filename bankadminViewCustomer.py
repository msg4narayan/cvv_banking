...
def loadCustomers():
	...
	bankadminViewCustomerWindow.title("Welcome to Financial Crimes | View Customers")
	bankadminViewCustomerWindow.state("zoomed")
	bankadminViewCustomerWindow.columnconfigure(1, weight=6)

	#Logo
	logo = tk.Label(bankadminViewCustomerWindow,text="Financial Crimes", font="Calibri 43")
